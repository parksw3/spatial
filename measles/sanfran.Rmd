...
Surprisingly, there's a strong quadratic mean-variance relationship (often, it's not this clear). So we need to fit negative binomial instead of Poisson. For convenience, we assume that we know proportion of susceptibles
...
Not so much. What can we do to make this fit better? We can try to simulate with extra variability.
...
matplot(simcases, type="l")
```

We get more interesting dynamics, which may resemble the dynamics observed in San Francisco much better.
